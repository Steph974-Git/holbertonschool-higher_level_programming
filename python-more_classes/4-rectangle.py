#!/usr/bin/python3
"""
Module définissant une classe Rectangle avec représentation et récréation.
...
ainsi que la capacité d'être recréée par eval().
"""


class Rectangle:
    """
    Classe représentant un rectangle avec largeur, hauteur et représentations.
