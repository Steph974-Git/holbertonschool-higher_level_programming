#!/usr/bin/python3
"""
Module définissant une classe Rectangle avec symbole d'affichage
personnalisable.
...
personnalisables, et un compteur qui suit le nombre d'instances.
"""


class Rectangle:
    """
    Classe représentant un rectangle avec symbole d'affichage configurable.
    ...
    def __init__(self, width=0, height=0):
        ...
        Note:
            Incrémente le compteur de classe number_of_instances lors
            de la création d'une nouvelle instance.
        """
        self.width = width
        self.height = height
    ...
    def __str__(self):
        ...
        Utilise l'attribut print_symbol (qui peut être personnalisé) pour
        générer la représentation visuelle du rectangle.
    ...
    def __del__(self):
        ...
        number_of_instances pour suivre le nombre d'instances actives.
        """
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1  # Décrémente le compteur de classe
