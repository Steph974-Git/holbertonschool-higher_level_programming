#!/usr/bin/python3
"""
Module définissant une classe Rectangle avec méthode de comparaison.
...
un compteur d'instances, et une méthode de comparaison d'aires.
"""


class Rectangle:
    """
    Classe représentant un rectangle avec fonctionnalités avancées.
